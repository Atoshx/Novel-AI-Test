...
class API:
    ...
    def __init__(self, username: str = None, password: str = None, base_address: Optional[str] = None):
        self._username = username or "PUT USERNAME"
        self._password = password or "PUT PASSWORD"
